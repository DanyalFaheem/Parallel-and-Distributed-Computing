/*
 Command to run: gcc filename.c -lpthread -lm -o exe 
*/
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
...
// Struct to pass as argument to function
struct coordinate
{
    int i, j, k;
} index;
...
void *SQUARE_MATRIX_MULTIPLY_THREAD_CYCLIC(void *arg)
{
    ...
    for (int counter = i; counter < j; counter++)
    {
        ...
        // As cycling switching blocks here
...
int main(int argc, char *argv[])
{
    ...
    // Calculating our block size here depending
